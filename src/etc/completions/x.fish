...
complete -c x -n "__fish_x_using_subcommand run" -l no-html-gen -d 'skip generating the HTML report when collecting compiler coverage'
...
complete -c x -n "__fish_x_using_subcommand r" -l no-html-gen -d 'skip generating the HTML report when collecting compiler coverage'
